  ...
  <div class="lg:mt-20 md:mt-20 sm:mt-5 px-4 sm:px-8 md:px-16 lg:px-32 xl:px-64">
    @foreach ($posts as $posting)
      @if ($posting->posting_image || $posting->posting_video)
          <article class="overflow-hidden my-5 rounded-b-lg transition">
              <div class="flex items-center lg:mx-40 lg:p-3 lg:mb-0 mb-5 justify-between">
              ...
              <div class=" p-4 rounded-b-lg border-b border-black lg:mx-44 sm:p-6">
                <div class="flex mt-5 items-center">
                  ...
                  <a href="/showTeks-guest/{{ $posting->slug }}" class="mt-2 line-clamp-3 text-md/relaxed text-gray-700">
