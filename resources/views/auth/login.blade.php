                ...
                <form method="POST" action="/login" class="mt-8 grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input
                            ...
                            id="email"
                            name="email"
                            class="mt-1 w-full rounded-md border-black bg-white text-sm focus:ring-abu-tua text-gray-700 shadow-sm"
                            value="{{ old('email') }}"
                            required
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input
                            ...
                            id="password"
                            name="password"
                            class="mt-1 w-full rounded-md border-black focus:ring-abu-tua bg-white text-sm text-gray-700 shadow-sm"
                            required
                    ...
                    {{-- <div class="col-span-6">
                        <label for="remember_me" class="inline-flex items-center">
                            <input id="remember_me" type="checkbox" class="rounded border-black text-abu-tua shadow-sm focus:ring-abu-muda" name="remember">
