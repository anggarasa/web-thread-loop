                ...
                <div class="bg-white p-4 rounded-lg shadow">
                    ...
                    <ul>
                        @foreach ($users as $user)
                            ...
                            <div data-popover id="detail-user-modal{{ $user->id }}" role="tooltip" class="absolute z-10 invisible inline-block w-64 text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 dark:text-gray-400 dark:bg-gray-800 dark:border-gray-600">
                                <div class="p-3">
                                    <div class="flex items-center justify-between mb-2">
                                        ...
                                        <div>
                                            @if (auth()->user()->isFollowing($user->id))
                                            <button type="button" class="unfollow-btn text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-xs px-3 py-1.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" data-id="{{ $user->id }}" data-username="{{ $user->username }}">Diikuti</button>
                                            @else
                                            <button type="button" class="follow-btn text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-xs px-3 py-1.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"data-id="{{ $user->id }}" data-username="{{ $user->username }}">Ikuti</button>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <p class="mb-4 text-sm">{{ $user->email }} <p class="text-blue-600 dark:text-blue-500 hover:underline">{{ $user->nohp }}</p></p>
                                    <ul class="flex text-sm">
                                        <li class="me-2">
                                            <div>
                                                <span class="font-semibold text-gray-900 dark:text-white">{{ $user->followers->count() }}</span>
                                                <span>Pengikut</span>
                                            </div>
                                        </li>
                                        <li>
                                            <div>
                                                <span class="font-semibold text-gray-900 dark:text-white">{{ $user->following->count() }}</span>
                                                <span>Diikuti</span>
                                            </div>
                                        </li>
                                    </ul>
